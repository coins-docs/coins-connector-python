...
from coins.lib.utils import get_timestamp
from coins.websocket.coins_socket_manager import CoinsSocketManager


class CoinsWebsocketClient:
    ...
    def __init__(
        ...
        self.logger.debug("Coins WebSocket Client started.")
