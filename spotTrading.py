...
org_order_id = user.order_openorders(symbol='XRPPHP', recv_window='', timestamp=timestamp)[0]['orderId']
pprint(user.order_cancel_replace(symbol='XRPPHP', side='buy', type='limit', time_in_force='GTC', quantity='6', quote_order_qty='', price='11', new_client_order_id='', stop_price='', new_order_resp_type='', recv_window='', timestamp=timestamp,stp_flag='',cancelOrderId=org_order_id,cancelReplaceMode='ALLOW_FAILURE', cancelOrigClientOrderId='',cancelRestrictions=''))
